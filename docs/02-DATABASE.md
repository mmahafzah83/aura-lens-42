...
capability_responses | Users can update their own capability responses | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
capability_responses | Users can view own capability responses | SELECT | authenticated | USING (auth.uid() = user_id)
capability_responses | cr_admin | ALL | authenticated | USING has_role(auth.uid(),'admin') | CHECK has_role(auth.uid(),'admin')
captures | Users can delete own captures | DELETE | authenticated | USING (auth.uid() = user_id)
captures | Users can insert own captures | INSERT | authenticated | CHECK (auth.uid() = user_id)
captures | Users can update own captures | UPDATE | authenticated | USING (auth.uid() = user_id)
captures | Users can view own captures | SELECT | authenticated | USING (auth.uid() = user_id)
chat_conversations | Users can delete own conversations | DELETE | authenticated | USING (auth.uid() = user_id)
chat_conversations | Users can insert own conversations | INSERT | authenticated | CHECK (auth.uid() = user_id)
chat_conversations | Users can update own conversations | UPDATE | authenticated | USING (auth.uid() = user_id)
chat_conversations | Users can view own conversations | SELECT | authenticated | USING (auth.uid() = user_id)
chat_messages | Users can delete own messages | DELETE | authenticated | USING (auth.uid() = user_id)
chat_messages | Users can insert own messages | INSERT | authenticated | CHECK (auth.uid() = user_id)
chat_messages | Users can view own messages | SELECT | authenticated | USING (auth.uid() = user_id)
content_gate_results | Service role can insert gate results | INSERT | service_role | CHECK true
content_gate_results | Users can view their own gate results | SELECT | authenticated | USING (auth.uid() = user_id)
content_items | Users can delete own content items | DELETE | public | USING (auth.uid() = user_id)
content_items | Users can insert own content items | INSERT | public | CHECK (auth.uid() = user_id)
content_items | Users can update own content items | UPDATE | public | USING (auth.uid() = user_id)
content_items | Users can view own content items | SELECT | public | USING (auth.uid() = user_id)
content_lineage | Admins read all lineage | SELECT | authenticated | USING is_current_user_admin()
content_lineage | Members read lineage for their own content | SELECT | authenticated | USING
    ((content_table='linkedin_posts' AND EXISTS (SELECT 1 FROM linkedin_posts p WHERE p.id=content_lineage.content_id AND p.user_id=auth.uid()))
     OR (content_table='content_items' AND EXISTS (SELECT 1 FROM content_items c WHERE c.id=content_lineage.content_id AND c.user_id=auth.uid())))
daily_brief_snapshots | admins can read daily briefs | SELECT | authenticated | USING is_current_user_admin()
decisions | Admins read decisions | SELECT | authenticated | USING is_current_user_admin()
decisions | Admins settle decisions | UPDATE | authenticated | USING is_current_user_admin() | CHECK is_current_user_admin()
decisions | Admins write decisions | INSERT | authenticated | CHECK is_current_user_admin()
deck_events | Members can insert their own deck events | INSERT | authenticated | CHECK (user_id = auth.uid())
deck_events | Members can view their own deck events | SELECT | authenticated | USING (user_id = auth.uid())
decks | decks_delete_own | DELETE | authenticated | USING (auth.uid() = user_id)
decks | decks_insert_own | INSERT | authenticated | CHECK (auth.uid() = user_id)
decks | decks_select_own | SELECT | authenticated | USING (auth.uid() = user_id)
decks | decks_update_own | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
design_system | Admin can manage design system | ALL | public | USING is_current_user_admin() | CHECK is_current_user_admin()
design_system | Authenticated users can read active design system | SELECT | authenticated | USING (is_active = true)
desk_answer_feedback | Members read their own answer feedback | SELECT | authenticated | USING (auth.uid() = user_id)
desk_answer_feedback | Members write their own answer feedback | INSERT | authenticated | CHECK (auth.uid() = user_id)
desk_answer_feedback | Service role manages answer feedback | ALL | service_role | USING true | CHECK true
desk_eval_questions | admins manage desk_eval_questions | ALL | authenticated | USING has_role(auth.uid(),'admin') | CHECK has_role(auth.uid(),'admin')
desk_eval_runs | admins manage desk_eval_runs | ALL | authenticated | USING has_role(auth.uid(),'admin') | CHECK has_role(auth.uid(),'admin')
desk_learning | Members dismiss their own learning | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
desk_learning | Members read their own learning | SELECT | authenticated | USING (auth.uid() = user_id)
desk_learning | Service role writes learning | ALL | service_role | USING true | CHECK true
diagnostic_profiles | Users can insert own profile | INSERT | authenticated | CHECK (auth.uid() = user_id)
diagnostic_profiles | Users can update own profile | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
diagnostic_profiles | Users can view own profile | SELECT | authenticated | USING (auth.uid() = user_id)
discovery_review_queue | Users can delete own review candidates | DELETE | authenticated | USING (auth.uid() = user_id)
discovery_review_queue | Users can insert own review candidates | INSERT | authenticated | CHECK (auth.uid() = user_id)
discovery_review_queue | Users can update own review candidates | UPDATE | authenticated | USING (auth.uid() = user_id)
discovery_review_queue | Users can view own review candidates | SELECT | authenticated | USING (auth.uid() = user_id)
document_briefs | Members read their own document briefs | SELECT | authenticated | USING (user_id = (SELECT auth.uid()))
document_briefs | Service role manages document briefs | ALL | service_role | USING true | CHECK true
document_chunks | Users can delete own chunks | DELETE | public | USING (auth.uid() = user_id)
document_chunks | Users can insert own chunks | INSERT | public | CHECK (auth.uid() = user_id)
document_chunks | Users can view own chunks | SELECT | public | USING (auth.uid() = user_id)
document_chunks | Users update own chunks | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
document_jobs | Users can view own document_jobs | SELECT | authenticated | USING (auth.uid() = user_id)
documents | Users can delete own documents | DELETE | public | USING (auth.uid() = user_id)
documents | Users can insert own documents | INSERT | public | CHECK (auth.uid() = user_id)
documents | Users can update own documents | UPDATE | public | USING (auth.uid() = user_id)
documents | Users can view own documents | SELECT | public | USING (auth.uid() = user_id)
draft_edits | Users can view their own draft edits | SELECT | authenticated | USING (auth.uid() = user_id)
ef_error_log | Admins read ef error log | SELECT | public | USING is_current_user_admin()
ef_event_log_retired_20260724 | Admins read ef event log | SELECT | public | USING is_current_user_admin()
entries | Users can create their own entries | INSERT | public | CHECK (auth.uid() = user_id)
entries | Users can delete their own entries | DELETE | public | USING (auth.uid() = user_id)
entries | Users can update their own entries | UPDATE | public | USING (auth.uid() = user_id)
entries | Users can view their own entries | SELECT | public | USING (auth.uid() = user_id)
eval_metrics | Users delete own eval metrics | DELETE | authenticated | USING (auth.uid() = user_id)
eval_metrics | Users insert own eval metrics | INSERT | authenticated | CHECK (auth.uid() = user_id)
eval_metrics | Users update own eval metrics | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
eval_metrics | eval_metrics_select_own_or_admin_system | SELECT | public | USING ((user_id = auth.uid()) OR (user_id IS NULL AND is_current_user_admin()))
evidence_fragments | Users can delete own fragments | DELETE | public | USING (auth.uid() = user_id)
evidence_fragments | Users can insert own fragments | INSERT | public | CHECK (auth.uid() = user_id)
evidence_fragments | Users can update own fragments | UPDATE | public | USING (auth.uid() = user_id)
evidence_fragments | Users can view own fragments | SELECT | public | USING (auth.uid() = user_id)
evidence_jobs | Users read own evidence jobs | SELECT | authenticated | USING (auth.uid() = user_id)
external_costs | Admins manage external costs | ALL | public | USING is_current_user_admin() | CHECK is_current_user_admin()
facet_states | Users delete own facet states | DELETE | authenticated | USING (auth.uid() = user_id)
facet_states | Users insert own facet states | INSERT | authenticated | CHECK (auth.uid() = user_id)
facet_states | Users update own facet states | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
facet_states | facet_states_select_own | SELECT | authenticated | USING (user_id = auth.uid())
focus_accounts | Users can delete own accounts | DELETE | public | USING (auth.uid() = user_id)
focus_accounts | Users can insert own accounts | INSERT | public | CHECK (auth.uid() = user_id)
focus_accounts | Users can update own accounts | UPDATE | public | USING (auth.uid() = user_id)
focus_accounts | Users can view own accounts | SELECT | public | USING (auth.uid() = user_id)
framework_activations | Users can delete own activations | DELETE | public | USING (auth.uid() = user_id)
framework_activations | Users can insert own activations | INSERT | public | CHECK (auth.uid() = user_id)
framework_activations | Users can update own activations | UPDATE | public | USING (auth.uid() = user_id)
framework_activations | Users can view own activations | SELECT | public | USING (auth.uid() = user_id)
freshness_checks | Admins can read freshness checks | SELECT | authenticated | USING is_current_user_admin()
guide_articles | Anyone can read guide articles | SELECT | anon | USING true
guide_articles | Authenticated users can read guide articles | SELECT | authenticated | USING true
guide_slug_misses | Admin only select misses | SELECT | public | USING is_current_user_admin()
health_findings | Admins can read health_findings | SELECT | authenticated | USING is_current_user_admin()
home_address | own address readable | SELECT | public | USING (auth.uid() = user_id)
impact_narratives | Users can read own impact narratives | SELECT | authenticated | USING (auth.uid() = user_id)
impact_narratives | Users delete own impact narratives | DELETE | authenticated | USING (auth.uid() = user_id)
impact_narratives | Users insert own impact narratives | INSERT | authenticated | CHECK (auth.uid() = user_id)
impact_narratives | Users update own impact narratives | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
import_jobs | Users can insert own import jobs | INSERT | authenticated | CHECK (auth.uid() = user_id)
import_jobs | Users can update own import jobs | UPDATE | authenticated | USING (auth.uid() = user_id)
import_jobs | Users can view own import jobs | SELECT | authenticated | USING (auth.uid() = user_id)
imprint_snapshots | Users delete own imprint snapshots | DELETE | authenticated | USING (auth.uid() = user_id)
imprint_snapshots | Users insert own imprint snapshots | INSERT | authenticated | CHECK (auth.uid() = user_id)
imprint_snapshots | Users update own imprint snapshots | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
imprint_snapshots | imprint_snapshots_select_own | SELECT | authenticated | USING (user_id = auth.uid())
industry_trends | Users can delete own trends | DELETE | public | USING (auth.uid() = user_id)
industry_trends | Users can insert own trends | INSERT | public | CHECK (auth.uid() = user_id)
industry_trends | Users can update own trends | UPDATE | public | USING (auth.uid() = user_id)
industry_trends | Users can view own trends | SELECT | public | USING (auth.uid() = user_id)
influence_snapshots | Users can delete own snapshots | DELETE | authenticated | USING (auth.uid() = user_id)
influence_snapshots | Users can insert own snapshots | INSERT | authenticated | CHECK (auth.uid() = user_id)
influence_snapshots | Users can update own snapshots | UPDATE | authenticated | USING (auth.uid() = user_id) | CHECK (auth.uid() = user_id)
influence_snapshots | Users can view own snapshots | SELECT | authenticated | USING (auth.uid() = user_id)
instrument_runs | own runs readable | SELECT | authenticated | USING (user_id = auth.uid())
known_issues | Admins can read known issues | SELECT | authenticated | USING is_current_user_admin()
learned_intelligence | Users can delete own intelligence | DELETE | public | USING (auth.uid() = user_id)
learned_intelligence | Users can insert own intelligence | INSERT | public | CHECK (auth.uid() = user_id)
learned_intelligence | Users can update own intelligence | UPDATE | public | USING (auth.uid() = user_id)
learned_intelligence | Users can view own intelligence | SELECT | public | USING (auth.uid() = user_id)
lifecycle_email_log | Admins can read lifecycle email log | SELECT | authenticated | USING is_current_user_admin()
lifecycle_emails | Admin reads all emails | SELECT | public | USING is_current_user_admin()

desk_number_violations | Admins read number violations | SELECT | authenticated | USING has_role(auth.uid(),'admin')
