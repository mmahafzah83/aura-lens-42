...
const Admin = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#0d0d0d", color: "#f0f0f0", fontFamily: "Inter, system-ui, sans-serif" }}
    >
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          ...
          <Select value={seniorityFilter} onValueChange={setSeniorityFilter}>
            <SelectTrigger
              ...
              style={{ backgroundColor: "#141414", borderColor: "#252525", color: "#f0f0f0" }}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr
                    ...
                    style={{ color: "#888", backgroundColor: "rgba(255,255,255,0.02)" }}
                  >
                  ...
                  {filtered.map((r) => (
                    <Fragment key={r.id}>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              <div className="font-semibold truncate" style={{ color: "#f0f0f0" }}>
                                {r.name || "—"}
                              </div>
                      ...
                      {activeInvite === r.id && r.status === "pending" && (
                        <tr style={{ borderTop: "1px solid #252525", backgroundColor: "rgba(255,255,255,0.02)" }}>
                          <td colSpan={5} className="px-4 py-4">
                            <div className="space-y-3">
                              <textarea
                                ...
                                rows={3}
                                className="w-full px-3 py-2 rounded-md text-sm outline-none focus:border-[#F97316] transition-colors"
                                style={{
                              ...
                              <div className="flex justify-end items-center gap-3">
                                ...
                                <button
                                  ...
                                  style={{ backgroundColor: "#F97316", color: "#0d0d0d" }}
                                >
                                  {sendingId === r.id ? (
