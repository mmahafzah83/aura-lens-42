...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "entries.linkedinPost": { en: "LinkedIn Post", ar: "منشور لينكدإن" },
  "entries.linkedinAr": { en: "Arabic LinkedIn", ar: "لينكدإن عربي" },
  "entries.translate": { en: "Executive Arabic", ar: "ترجمة تنفيذية" },
