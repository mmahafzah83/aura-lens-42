...
export const ONBOARDING_INTRO = {
  ...
  outputs: [
    ...
    { label: "What you can do", detail: "Ten parts of senior work, placed by you — so you can see which you'd struggle to prove." },
...
export const ENDING = {
  ...
  rowCapabilities: (n: number) => `${n} ${n === 1 ? "skill" : "skills"} placed`,
  rowCapabilitiesLabel: "What you can do",
