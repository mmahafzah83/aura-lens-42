...
const AURA = {
  ...
  brand: "#B08D3A",
  brandLine: "rgba(6,112,196,0.30)",
  brandFaint: "rgba(6,112,196,0.20)",
  brandWatermark: "rgba(6,112,196,0.25)",
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-0">
        {/* Full-size preview */}
        <div className="flex-1 p-6 flex items-center justify-center bg-ink-2 min-h-[480px]">
