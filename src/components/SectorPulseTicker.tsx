...
/* ── Expanded 2026 signals — 10+ per category ────────── */
const SEED_SIGNALS: Record<string, TickerItem[]> = {
  water: [
    // OFFICIAL (10)
    { headline: "NEOM Water Expansion 2026: SAR 3.2B desalination mega-plant breaks ground — capacity +45% by 2028", source: "Arab News", sourceType: "saudi_official", url: null, sector: "water", skillTarget: "Sector Foresight", bluf: "NEOM's mega-plant represents the largest single desalination investment in 2026|Regional water security shifts from scarcity-management to capacity-surplus, redefining utility ROI models|Position your client advisory around 'surplus-economy' frameworks — this is your next PoV anchor" },
    ...
    { headline: "PwC launches dedicated Water & Utilities practice in Riyadh — 30 specialists deployed", source: "PwC", sourceType: "competitors", url: "https://www.pwc.com", sector: "water", skillTarget: "Human-Centric Leadership", bluf: "PwC's dedicated practice launch intensifies competition for water sector mandates|Talent poaching risk increases — key EY water specialists may receive offers|Implement retention packages and establish clear career progression for water practice team" },
    { headline: "Bain advises MEWA on national water efficiency program — SAR 500M engagement scope", source: "Bain", sourceType: "competitors", url: "https://www.bain.com", sector: "water", skillTarget: "C-Suite Stewardship", bluf: "Bain's MEWA engagement gives them direct access to policy-making decision processes|MEWA influence shapes regulatory direction for the entire water sector|Counter by building direct relationships with MEWA's technology and innovation departments" },
    { headline: "Deloitte launches 'Water Digital Twin' offering — positions as technology-first water advisor", source: "Deloitte", sourceType: "competitors", url: "https://www.deloitte.com", sector: "water", skillTarget: "Digital Synthesis", bluf: "Deloitte's digital twin positioning differentiates them from traditional advisory competitors|Technology-first narrative may attract digitally-oriented utility operators|Develop EY's own 'Intelligent Water Operations' platform offering to compete on technology" },
    { headline: "McKinsey opens dedicated water research center in Riyadh — 10 PhDs in water science hired", source: "McKinsey", sourceType: "competitors", url: "https://www.mckinsey.com", sector: "water", skillTarget: "Sector Foresight", bluf: "McKinsey's research center investment signals long-term commitment to water sector dominance|PhD-level expertise gives them credibility advantage in technical advisory conversations|Partner with KAUST or NWRC to build EY's own research credibility in the water sector" },
    { headline: "BCG wins SAR 150M SWCC operational excellence program — 2-year transformation mandate", source: "BCG", sourceType: "competitors", url: "https://www.bcg.com", sector: "water", skillTarget: "Operational Resilience", bluf: "BCG's SWCC win ahead of the IPO gives them significant influence over the listing narrative|Operational excellence engagement positions BCG as the trusted advisor for IPO readiness|Target SWCC's finance and investor relations functions — areas outside BCG's current scope" },
    { headline: "Accenture deploys IoT platform across 3 Saudi water utilities — technology advisory dominance growing", source: "Accenture", sourceType: "competitors", url: "https://www.accenture.com", sector: "water", skillTarget: "Digital Synthesis", bluf: "Accenture's IoT deployment creates technology lock-in at 3 major utility operators|Technology implementation advisory is shifting from consulting firms to tech companies|Differentiate EY through 'Technology-Agnostic Advisory' positioning — strategic, not vendor-tied" },
    { headline: "KPMG captures water sector audit mandate for 4 regional utilities — assurance market share growing", source: "KPMG", sourceType: "competitors", url: "https://www.kpmg.com", sector: "water", skillTarget: "Value-Based P&L", bluf: "KPMG's audit wins erode EY's assurance market share in the water sector|Audit relationships often lead to consulting cross-sell opportunities|Defend remaining audit relationships and develop a 'beyond audit' cross-sell strategy" },
    // EY INTERNAL (10)
    ...
    { headline: "EY wins 'Water Advisory Firm of the Year' at GCC Infrastructure Awards 2025", source: "EY MENA", sourceType: "ey", url: null, sector: "water", skillTarget: "Executive Presence", bluf: "Award validates EY's water sector positioning and market credibility|Recognition should be leveraged in all pursuit materials and client communications|Ensure the award features prominently in your personal LinkedIn content and client presentations" },
    { headline: "EY MENA partners with KAUST for water technology innovation research program", source: "EY MENA", sourceType: "ey", url: null, sector: "water", skillTarget: "Sector Foresight", bluf: "KAUST partnership builds academic credibility that competitors lack|Research outputs can be converted into proprietary advisory frameworks|Engage with the research program to co-author publications and build personal thought leadership" },
    { headline: "EY launches 'WaterTech 50' index — ranking the most innovative water technology companies globally", source: "EY Global", sourceType: "ey", url: null, sector: "water", skillTarget: "Digital Synthesis", bluf: "WaterTech 50 index positions EY as the connector between technology and utilities|Index creates deal flow for EY's corporate finance and M&A advisory teams|Use the index to identify acquisition targets for Saudi utility clients seeking technology capabilities" },
    ...
    { headline: "EY deploys proprietary 'Aqua Analytics' platform for real-time water infrastructure monitoring", source: "EY Global", sourceType: "ey", url: null, sector: "water", skillTarget: "Digital Synthesis", bluf: "Aqua Analytics creates a technology-enabled advisory differentiator against competitors|Platform deployment in Saudi would be a first-in-region achievement|Champion the Aqua Analytics pilot with a Saudi utility client to build implementation credentials" },
    { headline: "EY appoints new MENA Water & Utilities Sector Lead — Director-level promotion announced", source: "EY MENA", sourceType: "ey", url: null, sector: "water", skillTarget: "C-Suite Stewardship", bluf: "New sector lead appointment signals organizational commitment to structured water practice growth|Leadership change creates opportunity to influence practice direction and strategy|Schedule a strategic alignment meeting with the new lead within 30 days" },
    { headline: "EY Global CEO highlights water scarcity as top ESG risk — MENA positioned as response hub", source: "EY Global", sourceType: "ey", url: null, sector: "water", skillTarget: "Geopolitical Fluency", bluf: "Global CEO endorsement elevates water advisory priority across all EY regions|MENA response hub positioning attracts global talent and investment|Align personal brand with the global ESG-water narrative for maximum visibility" },
    { headline: "EY MENA launches water sector client roundtable series — quarterly C-suite engagement", source: "EY MENA", sourceType: "ey", url: null, sector: "water", skillTarget: "Executive Presence", bluf: "Client roundtable creates recurring C-suite relationship building opportunities|Quarterly cadence ensures sustained visibility with top water sector decision-makers|Secure a permanent seat at the roundtable and volunteer to moderate at least one session" },
  ],
  finance: [
    ...
    { headline: "SAMA approves 5 new digital bank licenses — challenger banks reshape retail banking", source: "SAMA", sourceType: "saudi_official", url: null, sector: "finance", skillTarget: "Digital Synthesis", bluf: "5 new digital bank licenses fragment the retail banking landscape|Incumbent banks need defensive digital strategies and customer retention programs|Offer 'Digital Bank Response Strategy' engagements to top 5 traditional Saudi banks" },
