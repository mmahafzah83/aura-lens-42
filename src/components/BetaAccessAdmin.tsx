    ...
    <div id="beta-admin-section" className="mt-8 pt-8 border-t border-border/40 scroll-mt-24">
      <div className="glass-card rounded-2xl p-6 sm:p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-8 h-8 rounded-xl bg-[var(--bronze)]/10 flex items-center justify-center border border-[var(--bronze)]/30">
            <Shield className="w-4 h-4 text-[var(--bronze)]" />
          </div>
          <h3
        ...
        {loading ? (
          ...
          <>
            {/* Bulk action bar */}
            {selectedIds.size > 0 && (
              <div className="mb-3 rounded-xl border border-[var(--bronze)]/30 bg-[var(--bronze)]/5 p-3 sm:p-4 space-y-3">
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  <div className="flex items-center gap-2 text-sm">
                    <CheckSquare className="w-4 h-4 text-[var(--bronze)]" />
                  ...
                  <Fragment key={r.id}>
                    <tr
                      className={`border-t border-border/30 hover:bg-secondary/20 ${
                        selectedIds.has(r.id) ? "bg-[var(--bronze)]/5" : ""
                      }`}
                    >
      ...
      <div className="glass-card rounded-2xl p-6 sm:p-8 mt-6">
        <div className="flex items-center gap-3 mb-5">
          <div className="w-8 h-8 rounded-xl bg-[var(--bronze)]/10 flex items-center justify-center border border-[var(--bronze)]/30">
            <History className="w-4 h-4 text-[var(--bronze)]" />
          </div>
          <div>
            <h3
              className="text-xs font-semibold uppercase tracking-[0.15em]"
                  ...
                  return (
                    <tr key={`audit-${r.id}`} className="border-t border-border/30 hover:bg-secondary/20">
                      ...
                      <td className="px-3 py-3">
                        {hasNote ? (
                          <span
                            className="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full border bg-[var(--bronze)]/10 text-[var(--bronze-text)] border-[var(--bronze)]/30"
