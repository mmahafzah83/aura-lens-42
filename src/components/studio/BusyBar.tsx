...
export const BusyBar: React.FC<{
  ...
  /**
   * No honest estimate exists for this wait. The bar animates without
  ...
  }, [message, etaSeconds, indeterminate]);
    ...
    >
      ...
      >
        {indeterminate ? (
          <>
            <style>
              {"@keyframes busybar-sweep{0%{inset-inline-start:-40%}100%{inset-inline-start:100%}}"}
            </style>
            <span
              style={{
                position: "absolute",
