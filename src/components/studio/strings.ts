...
export const T = {
  ...
  // Read after the visible origin label, as one accessible name:
  // "From your signal. Go back to it." / "من إشارتك. الرجوع إلى المصدر."
  originBack: { en: "Go back to it", ar: "الرجوع إلى المصدر" },
...
export const themeName: Record<string, { en: string; ar: string }> = {
  ...
  crumple_oxblood: { en: "Oxblood", ar: "أحمر داكن" },
  crumple_ink: { en: "Ink", ar: "حبريّ" },
  crumple_teal: { en: "Teal", ar: "أزرق مخضرّ" },
  gridpaper_yellow: { en: "Yellow", ar: "أصفر" },
  gridpaper_red: { en: "Red", ar: "أحمر" },
  gridpaper_blue: { en: "Blue", ar: "أزرق" },
  gridpaper_green: { en: "Green", ar: "أخضر" },
  highlighter_orange: { en: "Orange", ar: "برتقاليّ" },
  highlighter_green: { en: "Green", ar: "أخضر" },
  highlighter_blue: { en: "Blue", ar: "أزرق" },
  highlighter_magenta: { en: "Magenta", ar: "أرجوانيّ" },
  salford_navy: { en: "Navy", ar: "كحليّ" },
  salford_plum: { en: "Plum", ar: "برقوقيّ" },
  salford_amber: { en: "Amber", ar: "كهرماني" },
  salford_teal: { en: "Teal", ar: "أزرق مخضرّ" },
  blueprint_violet: { en: "Violet", ar: "بنفسجيّ" },
  blueprint_cyan: { en: "Cyan", ar: "سماويّ" },
  blueprint_amber: { en: "Amber", ar: "كهرماني" },
  blueprint_green: { en: "Green", ar: "أخضر" },
  concept_violet: { en: "Concept violet", ar: "بنفسجيّ متدرّج" },
  concept_indigo: { en: "Indigo", ar: "نيليّ" },
  concept_teal: { en: "Teal", ar: "أزرق مخضرّ" },
  concept_crimson: { en: "Crimson", ar: "قرمزيّ" },
};
