...
import { PRODUCT_DESCRIPTOR, PRODUCT_DESCRIPTOR_CAPS } from "@/lib/brand";
...
const AccountIntelligence = ({ entries = [] }: AccountIntelligenceProps) => {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      doc.text(PRODUCT_DESCRIPTOR_CAPS, margin, 18);
      ...
      doc.setFontSize(6);
      doc.text(`Generated by Aura — ${PRODUCT_DESCRIPTOR}`, margin, footerY);
