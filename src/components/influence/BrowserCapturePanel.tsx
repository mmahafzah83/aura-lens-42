    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        <div className="p-3 rounded-xl bg-secondary/10 border border-border/5 space-y-1">
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-xs text-muted-foreground/35">Status</p>
          </div>
        ...
        <div className="p-3 rounded-xl bg-secondary/10 border border-border/5 space-y-1">
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-xs text-muted-foreground/35">Snapshots</p>
          </div>
        ...
        <div className="p-3 rounded-xl bg-secondary/10 border border-border/5 space-y-1">
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-xs text-muted-foreground/35">Posts</p>
          </div>
        ...
        <div className="p-3 rounded-xl bg-secondary/10 border border-border/5 space-y-1">
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-xs text-muted-foreground/35">Metrics</p>
          </div>
      ...
      <div className="pt-3 border-t border-border/5 space-y-3">
        <div className="flex items-start gap-2.5">
          ...
          <div className="space-y-2 text-xs text-muted-foreground/35 leading-relaxed">
            <p>
        ...
        <div className="space-y-3 pt-2 border-t border-border/5">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 text-xs font-medium text-primary/60 hover:text-primary px-4 py-2 rounded-lg hover:bg-primary/5 border border-primary/10 transition-all tactile-press"
            >
              <Download className="w-3.5 h-3.5" />
              Download Extension
            </button>
          </div>
          <div className="text-xs text-muted-foreground/25 space-y-0.5 pl-1">
