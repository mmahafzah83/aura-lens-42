...
BEGIN
  ...
  -- the goal is the input that gives "opportunity" a meaning, so it is read
  -- from his own profile and proposed before anything is shown
  ...
  SELECT COALESCE(jsonb_agg(
    ...
    || jsonb_build_object(
      ...
      -- the one thing still missing, asked on the card, answered in one line
