...
- NO REPETITION RULE: natural_tone, authority_style, and trust_pattern must each say something the other two do not — never restate the same sentence with light rewording.
