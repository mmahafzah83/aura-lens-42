...
const buildEmailHtml = (BRAND: string, BRAND_FONT: string) => `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { background-color: #f0ede8; font-family: '${BRAND_FONT}', -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; }
...
<div class="email-wrapper" style="padding:24px;background-color:#f0ede8;">
  <div class="email-card" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;">
    ...
    <div class="hero-pad" style="padding:48px 40px 40px;background:linear-gradient(135deg,#0d0d0d,#1a1a1a);color:#f0f0f0;">
      <p style="font-size:13px;color:${BRAND};letter-spacing:0.08em;text-transform:uppercase;margin-bottom:16px;">⚡ Aura · Strategic Intelligence</p>
    ...
    <div class="content-pad" style="padding:40px;color:#1a1a1a;">
      ...
      <div style="margin-bottom:14px;padding:18px;background:#faf8f4;border-radius:8px;border-left:3px solid ${BRAND};">
      ...
      <div style="margin-bottom:32px;padding:18px;background:#faf8f4;border-radius:8px;border-left:3px solid ${BRAND};">
      ...
      <table role="presentation" width="100%" style="margin-bottom:36px;border-collapse:collapse;">
        <tr class="feature-row">
          <td class="proof-cell" style="text-align:center;padding:16px;background:#0d0d0d;border-radius:8px 0 0 8px;color:#fff;">
            <div style="font-size:24px;font-weight:700;color:${BRAND};">3×</div>
          ...
          <td class="proof-cell" style="text-align:center;padding:16px;background:#1a1a1a;color:#fff;">
            <div style="font-size:24px;font-weight:700;color:${BRAND};">&lt;5 min</div>
          ...
          <td class="proof-cell" style="text-align:center;padding:16px;background:#0d0d0d;border-radius:0 8px 8px 0;color:#fff;">
            <div style="font-size:24px;font-weight:700;color:${BRAND};">100%</div>
      ...
      <div style="text-align:center;margin-bottom:14px;">
        <a href="{{CONFIRMATION_URL}}" class="cta-btn" style="display:inline-block;background:${BRAND};color:#0d0d0d;padding:18px 36px;border-radius:8px;font-weight:700;font-size:16px;">Activate my Aura account →</a>
      </div>
      ...
      <p style="font-size:12px;color:#888;line-height:1.6;margin-bottom:32px;word-break:break-all;">If the button doesn't work, copy this link:<br><a href="{{CONFIRMATION_URL}}" style="color:${BRAND};">{{CONFIRMATION_URL}}</a></p>
      ...
      <div style="margin-bottom:12px;"><strong style="color:${BRAND};">1.</strong> <strong style="color:#0d0d0d;">Activate your account</strong> — <span style="color:#555;font-size:14px;">Click the button above. Set your password. You're in — takes under a minute.</span></div>
      <div style="margin-bottom:12px;"><strong style="color:${BRAND};">2.</strong> <strong style="color:#0d0d0d;">Build your story — 5 minutes</strong> — <span style="color:#555;font-size:14px;">Answer 5 questions about your expertise, sector, and positioning. This trains your personal voice engine — every post Aura generates will sound unmistakably like you.</span></div>
      <div style="margin-bottom:12px;"><strong style="color:${BRAND};">3.</strong> <strong style="color:#0d0d0d;">Capture your first source</strong> — <span style="color:#555;font-size:14px;">Paste any article URL or drop a document into the Capture tab. Aura reads it, extracts the signals, and stores them in your intelligence layer. No manual tagging. No effort.</span></div>
      <div style="margin-bottom:32px;"><strong style="color:${BRAND};">4.</strong> <strong style="color:#0d0d0d;">Generate your first post</strong> — <span style="color:#555;font-size:14px;">Go to Publish → Flash. Pick a signal. Hit generate. Your first post — in your voice, from your intelligence — is ready in under 5 minutes.</span></div>
    ...
    <div class="footer-pad" style="padding:32px 40px;background:#0d0d0d;color:#888;">
      <p style="font-size:13px;color:${BRAND};font-weight:700;margin-bottom:6px;">Aura</p>
...
serve(async (req) => {
  ...
  try {
    ...
    // Build email HTML
    const html = buildEmailHtml(BRAND, BRAND_FONT)
      .replace(/{{NAME}}/g, name)
