...
- كل سطر = فكرة واحدة فقط
- سطر فارغ بين كل فكرة
- لا فقرات طويلة إطلاقاً
- رقم واحد فقط في منتصف البوست — بعد بناء التوتر، ليس في البداية
- اكتب على Level 3 و 4 فقط: ربط بسلوك مؤسسي + تحدي القارئ
