...
- Hook: First 1-2 lines must capture attention (contrarian, bold, statistic, promise)
- Structure: Steps, principles, frameworks, rules, lessons, mistakes, before/after, problem/solution
- Explanation pattern: Concept → Short explanation → Example
- Line rhythm: Short insight → explanation → reflection
- Authority signals: numbers, experiments, results, personal experience
- Insert mini insights throughout
